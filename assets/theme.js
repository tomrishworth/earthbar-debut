...
// Fix Add to Cart form to header on scroll

// var productContainer = $('#shopify-section-product-template');
// var productForm = $('.product-form');
// var formSpacer = $('.form-spacer');
// var productFormPosition = productForm.offset();
// var productFormHeight = productForm.outerHeight();
...
//       formSpacer.css('height', productFormHeight + 'px');
//     } else {
//       formSpacer.css('height', 0);
...
$(window).resize(function () {
  ...
  if (windowsize > 440 && $('body.template-product').length > 0) {
    // window.addEventListener('scroll', onScroll);
  }
});
